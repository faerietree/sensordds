...
public class Rule {
	...
	public Rule(String name, RuleBlock ruleBlock) {
		this.antecedents = new RuleExpression();
		this.consequents = new LinkedList<RuleTerm>();
	 ...
	 */
	public void evaluate(RuleActivationMethod ruleImplicationMethod) {
		//---
	...
	public String toString() {
		...
		while(itc.hasNext()) {
			RuleTerm term = (RuleTerm) itc.next();
